...
Source0  : https://github.com/flatpak/xdg-desktop-portal/releases/download/1.0.1/xdg-desktop-portal-1.0.1.tar.xz
...
%prep
%setup -q -n xdg-desktop-portal-1.0.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1535723811
