...
Version  : 1.14.1
Release  : 23
URL      : https://github.com/flatpak/xdg-desktop-portal/releases/download/1.14.1/xdg-desktop-portal-1.14.1.tar.xz
Source0  : https://github.com/flatpak/xdg-desktop-portal/releases/download/1.14.1/xdg-desktop-portal-1.14.1.tar.xz
...
%prep
%setup -q -n xdg-desktop-portal-1.14.1
cd %{_builddir}/xdg-desktop-portal-1.14.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647907305
...
cp %{_builddir}/xdg-desktop-portal-1.14.1/COPYING %{buildroot}/usr/share/package-licenses/xdg-desktop-portal/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
