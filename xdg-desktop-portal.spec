...
Version  : 1.8.0
Release  : 17
URL      : https://github.com/flatpak/xdg-desktop-portal/releases/download/1.8.0/xdg-desktop-portal-1.8.0.tar.xz
Source0  : https://github.com/flatpak/xdg-desktop-portal/releases/download/1.8.0/xdg-desktop-portal-1.8.0.tar.xz
...
%prep
%setup -q -n xdg-desktop-portal-1.8.0
cd %{_builddir}/xdg-desktop-portal-1.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605568647
...
cp %{_builddir}/xdg-desktop-portal-1.8.0/COPYING %{buildroot}/usr/share/package-licenses/xdg-desktop-portal/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
