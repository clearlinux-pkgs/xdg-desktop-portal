...
Version  : 1.18.4
Release  : 33
URL      : https://github.com/flatpak/xdg-desktop-portal/releases/download/1.18.4/xdg-desktop-portal-1.18.4.tar.xz
Source0  : https://github.com/flatpak/xdg-desktop-portal/releases/download/1.18.4/xdg-desktop-portal-1.18.4.tar.xz
...
%prep
%setup -q -n xdg-desktop-portal-1.18.4
cd %{_builddir}/xdg-desktop-portal-1.18.4
pushd ..
cp -a xdg-desktop-portal-1.18.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713474638
