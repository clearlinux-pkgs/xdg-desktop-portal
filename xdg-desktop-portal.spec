...
Source0  : https://github.com/flatpak/xdg-desktop-portal/releases/download/1.14.2/xdg-desktop-portal-1.14.2.tar.xz
...
%prep
%setup -q -n xdg-desktop-portal-1.14.2
cd %{_builddir}/xdg-desktop-portal-1.14.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648597599
export GCC_IGNORE_WERROR=1
export CFLAGS="$CFLAGS -fno-lto "
export FCFLAGS="$FFLAGS -fno-lto "
export FFLAGS="$FFLAGS -fno-lto "
export CXXFLAGS="$CXXFLAGS -fno-lto "
%configure --disable-static --disable-pipewire \
...
cp %{_builddir}/xdg-desktop-portal-1.14.2/COPYING %{buildroot}/usr/share/package-licenses/xdg-desktop-portal/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
