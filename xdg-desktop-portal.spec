...
Source0  : https://github.com/flatpak/xdg-desktop-portal/releases/download/1.14.6/xdg-desktop-portal-1.14.6.tar.xz
...
%prep
%setup -q -n xdg-desktop-portal-1.14.6
cd %{_builddir}/xdg-desktop-portal-1.14.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659587558
