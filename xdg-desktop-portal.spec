...
%prep
%setup -q -n xdg-desktop-portal-1.7.2
cd %{_builddir}/xdg-desktop-portal-1.7.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588209390
...
cp %{_builddir}/xdg-desktop-portal-1.7.2/COPYING %{buildroot}/usr/share/package-licenses/xdg-desktop-portal/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
