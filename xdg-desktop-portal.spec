...
Source0  : https://github.com/flatpak/xdg-desktop-portal/releases/download/1.14.3/xdg-desktop-portal-1.14.3.tar.xz
...
%prep
%setup -q -n xdg-desktop-portal-1.14.3
cd %{_builddir}/xdg-desktop-portal-1.14.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650059179
...
cp %{_builddir}/xdg-desktop-portal-1.14.3/COPYING %{buildroot}/usr/share/package-licenses/xdg-desktop-portal/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
