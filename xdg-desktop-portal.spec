...
Source0  : https://github.com/flatpak/xdg-desktop-portal/releases/download/1.0.3/xdg-desktop-portal-1.0.3.tar.xz
...
Requires: xdg-desktop-portal-config = %{version}-%{release}
...
Group: Development
Requires: xdg-desktop-portal-bin = %{version}-%{release}
Requires: xdg-desktop-portal-data = %{version}-%{release}
...
%prep
%setup -q -n xdg-desktop-portal-1.0.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1539271587
